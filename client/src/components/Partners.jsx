...
const Partners = () => {
    ...
    return (
        <div className="relative py-4  px-4 sm:px-[5vw] md:px-[7vw] lg:px-[5vw] bg-white poppins " >
            <div
                className="absolute  text-white left-0 top-0 z-0"
            >
                {/* <img src={serviceellipse} alt="" /> */}
            </div>
            <div className='bg-white  py-2 z-50 rounded-lg'>
                <div className="text-start mb-12">
                    {/* <p className="text-body font-heading text-primary font-bold mb-2 text-center ">10+ Partners</p> */}
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-medium mb-4 font-heading text-darkGray lg:leading-tight">
                        Our Partners
                    </h2>
                </div>
                <Marquee autoFill="true" pauseOnHover="false" className="overflow-hidden no-scrollbar ">
                    {skills.map((skill) => (
                        <div key={skill.name} className="block-container w-40 h-40 flex justify-center items-center">
